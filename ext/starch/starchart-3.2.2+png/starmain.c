...
static char rcsid[]="$Header: /cvsroot/starchart/starchart/starmain.c,v 1.1.1.1 2000/07/27 19:00:12 gfk Exp $";
...
#define COMMBUFLEN 1000
  ...
  /* Read user's .starrc */
   user_rcfile = getenv("HOME");
   strcat(user_rcfile, "/.starrc");
   if (NULL != user_rcfile) {
     rc_read(user_rcfile);
   }
