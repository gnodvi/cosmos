...
extern void init_stars (int num_test,
                       point_2d *cur, point_2d *prev, double *m,
                       point_2d *vk[], point_2d *ak[],
                       int max_stars, sys_param_type *sp, star_disp_type *sd, 
                       int DEBUG_var);

extern void new_star (int num_test,
                     point_2d *cur, point_2d *prev, double *m, 
                     point_2d *vk[], point_2d *ak[],
                     int max_stars, sys_param_type *sp, star_disp_type *sd,
                     int add_collapsar, int DEBUG_var);


extern void set_sys_param( sys_param_type *sp, int max_stars, int DEBUG_var);
...
extern void Animate(int num_test, int my_count_max, int DEBUG_var, int is_X);
...
/*----------------------------- Global Variables ----------------------------*/
//
// очень плохо, что так много переменных глобальных !!
// 
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
