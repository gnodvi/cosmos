...
/*
  ...
  */
//------------------------------------------------------------------------------
void init_stars (int num_test,
                 point_2d *cur, 
                 point_2d *prev, double *m,
                 ...
                 int DEBUG_var)
{
  ...
  if (DEBUG_var) is_X = 0; // пока так временно 
  ...
  case 0:
    ...
    set_sys_param ( sp, max_stars, DEBUG_var);
  ...
  default :
    printf ("!!!!!!!!!!! ERROR in num_test (predefined star system) \n\n");
    exit (1);
  }
  //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
